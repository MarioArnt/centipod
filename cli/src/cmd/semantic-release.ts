import { CentipodErrorCode, Project, resloveProjectRoot, semanticRelease as release, hasSemanticReleaseTags, createSemanticReleaseTag } from "@centipod/core";;
...
export const semanticRelease  = async (identifier?: string): Promise<void> => {
  try {
...
export const semanticReleaseInit  = async (options: { yes: boolean, access: string, dry: boolean }): Promise<void> => {
